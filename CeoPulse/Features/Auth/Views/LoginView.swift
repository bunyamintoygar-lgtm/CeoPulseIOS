                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                HStack {
                                    ...
                                    if isPasswordVisible {
                                        TextField("", text: $password, prompt: Text("login_password_placeholder".localized()).foregroundColor(AppColors.textSecondary))
                                            .foregroundColor(.white)
                                    } else {
                                        SecureField("", text: $password, prompt: Text("login_password_placeholder".localized()).foregroundColor(AppColors.textSecondary))
                                            .foregroundColor(.white)
                                    }
